...
class QuantastorClient(object):
    ...
    def make_call(self, api, payload):
        ...
        r = requests.get(strURL,  params=payload, verify=False, auth=self._auth)
